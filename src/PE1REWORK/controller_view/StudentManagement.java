package PE1REWORK.controller_view;


import PE1.model.Student;
import PE1.model.comparator.StudentComparatorByID;
import PE1.until.Validation;
import PE1REWORK.model.StudentList;
import PE1REWORK.model.comparator.StudentComparatorByGPA;
import PE1REWORK.model.comparator.StudentComparatorByOld;
    ...
    private void search() {
        ...
        new Menu<String>("Student Searching", searchOptions) {
            ...
            public void execute(int choice) {
                ...
                StudentComparatorByGPA comparator = null;

                switch (choice) {
                    case 1 -> {
                        ID = Validation.getString("Enter ID (st. ID QE000000): ", "[dD][eE][\\d]{6}");
    ...
    private void sort() {
        ...
        new Menu<String>("Student Sorting", sortOptions) {
            ...
            public void execute(int choice) {
                ...
                if (comparator != null) {
                    studentList.listAllStudents((List<PE1REWORK.model.Student>) comparator);
                }
            }
        }.run();
    }
